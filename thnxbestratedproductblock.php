...
include_once(_PS_MODULE_DIR_.'thnxbestratedproductblock/classes/thnxbestratedproductblockclass.php');
class thnxbestratedproductblock extends Module implements WidgetInterface
{
	private $_html = '';
	private $_hooks = '';
	public static $inlinejs = array();
	public static $module_name = 'thnxbestratedproductblock';
	public static $tablename = 'thnxbestratedproductblock';
	public static $classname = 'thnxbestratedproductblockclass';
    public $css_files = array(
    	array(
			'key' => 'thnxbestratedproductblock_css',
			'src' => 'thnxbestratedproductblock.css',
			'priority' => 150,
			'media' => 'all',
			'load_theme' => false,
		),
	...
	public $js_files = array(
		array(
			'key' => 'thnxbestratedproductblock_js',
			'src' => 'thnxbestratedproductblock.js',
			'priority' => 150,
	...
	{
		$this->name = 'thnxbestratedproductblock';
		...
		$this->displayName = $this->l('Platinum Theme Best Rated Products Block');
		$this->description = $this->l('Platinum Theme Best Rated Products Block Modules.');
        ...
        if((isset($this->context->controller->controller_type)) && ($this->context->controller->controller_type == 'front' || $this->context->controller->controller_type == 'modulefront')){
			global $smarty;
			smartyRegisterFunction($smarty, 'block', 'thnxbestratedproductblock_js', array('thnxbestratedproductblock', 'thnxbestratedproductblock_js'));
	...
	public static function thnxbestratedproductblock_js($params, $content, &$smarty)
	{
